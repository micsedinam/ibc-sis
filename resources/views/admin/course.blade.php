                     ...
                     <div class="row">
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('c_code') ? ' has-error' : '' }}">
                                ...
                                <input type="number" pattern=".{3}" onkeypress="validate()" class="form-control border-input" placeholder="101" name="c_code" value="{{ old('c_code') }}" required="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('c_name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control border-input" placeholder="Accounting" name="c_name" value="{{ old('c_name') }}" required="">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('level') ? ' has-error' : '' }}" required>
                                ...
                                <select id="level" class="form-control border-input" name="level" value="{{ old('level') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('credit_hrs') ? ' has-error' : '' }}" required>
                                ...
                                <select id="credit_hrs" class="form-control border-input" name="credit_hrs" value="{{ old('credit_hrs') }}" required>
