...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <a class="btn btn-primary" href="{{ url('admin/staff') }}" > Mange staff</a>
            <hr>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('firstname') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control border-input" autofocus="" placeholder="George" name="firstname" value="{{ old('firstname') }}" required="">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <input type="number" class="form-control border-input" onkeypress="validate()" pattern=".{10}" placeholder="0240000000" name="phone" value="{{ old('phone') }}" required="">
